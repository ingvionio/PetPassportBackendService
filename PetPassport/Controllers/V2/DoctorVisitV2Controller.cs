...
{
    [ApiController]
    [Route("api/v2/doctor-visit")]
    public class DoctorVisitV2Controller : EventControllerBaseV2<DoctorVisitEvent, DoctorVisitDto>
    {
        public DoctorVisitV2Controller(AppDbContext db) : base(db) { }
